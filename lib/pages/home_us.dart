                  ...
                  children: [
                    for (var request in usRequests.reversed)
                      request['status'] == '0'
                          ? GestureDetector(
                              onTap: () {
                             request['type'] == '0'?   Navigator.pushAndRemoveUntil(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => UsResponse(user: widget.user,request: request,)),
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                             ...
                                             Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                               children: [
                                                 Container(  width: size.width/20,height: size.width/20,
                                                        color: setUniColor(request['unit'].toString()),),
                                                 Padding(
                                                   padding: const EdgeInsets.all(8.0),
                                                   child: Text(
