...
class UsHistory extends StatefulWidget {
  final List source;
  UsHistory({Key? key, required this.source}) : super(key: key);
  @override
  _DataPageState createState() => _DataPageState();
}

class _DataPageState extends State<UsHistory> {
              ...
              child: GestureDetector(
                ...
                child: Row(
                  children: [
                    ...
                    Icon(_shouldSee?Icons.arrow_drop_up:Icons.arrow_drop_down)
                  ],
                ),
              ),
            ),
            for (var i in labRequestWidgets.reversed) 
            Visibility(visible: _shouldSee,
              child: i)
