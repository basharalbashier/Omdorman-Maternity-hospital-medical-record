...
Widget houseOfficerFollowUpTable(List data, context, Map file, User user) {
        ...
        child: Row(
          ...
          children: [
            addButtonModel(
                "+",
                (() async =>
                    addhouseOfficerFollowUpTable(context, file, user, size))),
          ],
        ),
      ),
      Padding(
...
Future<void> addhouseOfficerFollowUpTable(
  contexte,
  Map file,
  User user,
  size,
